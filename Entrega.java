...
class Entrega {
   ...
   * (per exemple, `Predicate<Integer> p`). Per avaluar aquest predicat, si `x` és un elemento de
   ...
   * avaluar com f.apply(x) (on x és d'a i el resultat f.apply(x) és de b).
    ...
    static class Tema2 {
        ...
        /*
     * Comprovau si la relació `relacion` definida sobre `a` és d'equivalència.
     *
     * Podeu soposar que `a` està ordenat de menor a major.
        ...
        static boolean exercici1(int[] a, int[][] rel) {
            ...
            for (int elemento : a) {
                if (!relacion(elemento, elemento, rel)) {
            ...
            for (int elemento1 : a) {
                for (int elemento2 : a) {
                    if (relacion(elemento1, elemento2, rel) != relacion(elemento2, elemento1, rel)) {
            ...
            for (int element1 : a) {
                for (int element2 : a) {
                    for (int element3 : a) {
                        if (relacion(element1, element2, rel) && relacion(element2, element3, rel) && !relacion(element1, element3, rel)) {
            ...
            return true; // es compleixen les condicions per que relacion sigui d'equivalencia
            // TO DO
        }

        static boolean relacion(int element1, int element2, int[][] rel) {

            return element1 == element2;
        }

        /*
     * Comprovau si la relació `relacion` definida sobre `a` és d'equivalència. Si ho és, retornau el
     * cardinal del conjunt quocient de `a` sobre `relacion`. Si no, retornau -1.
     *
     * Podeu soposar que `a` està ordenat de menor a major.
         */
        ...
        /*
     * Comprovau si la relació `relacion` definida entre `a` i `b` és una funció.
     *
     ...
     * - Si és exhaustiva, el màxim cardinal de l'antiimatge de cada elemento de `codom`.
     ...
     * Aquí teniu alguns exemples i proves relacionades amb aquests exercicis (vegeu `main`)
        ...
        static void tests() {
            ...
            // Exercici 2
            // si `relacion` és d'equivalència, quants d'elements té el seu quocient?
   ...
   * on cada elemento i-èssim serà un array ordenat que contendrà els índexos dels vèrtexos adjacents
